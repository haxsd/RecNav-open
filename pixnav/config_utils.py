...
PIXNAV_GPU_DEVICE_ID = int(os.environ.get("PIXNAV_GPU_DEVICE_ID", "-1"))

# habitat config used to run the benchmark for objnav in hm3d dataset
def hm3d_config(path:str=HM3D_CONFIG_PATH,stage:str='val',episodes=200,max_episode_steps:int=0):
    ...
    with read_write(habitat_config):
        ...
        habitat_config.habitat.simulator.habitat_sim_v0.gpu_device_id = PIXNAV_GPU_DEVICE_ID
