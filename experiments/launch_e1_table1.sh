...
bash "${SCRIPT_DIR}/run_experiment.sh" random_walk_locked "${SEED}" "${EPISODES}" "${BUDGET}"
bash "${SCRIPT_DIR}/run_experiment.sh" frontier_locked "${SEED}" "${EPISODES}" "${BUDGET}"
bash "${SCRIPT_DIR}/run_experiment.sh" llm_replan_locked "${SEED}" "${EPISODES}" "${BUDGET}"
